...
```javascript
Float16Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-float16@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var Float16Array = require( 'path/to/vendor/umd/array-float16/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/array-float16.svg
[npm-url]: https://npmjs.org/package/@stdlib/array-float16

[test-image]: https://github.com/stdlib-js/array-float16/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/array-float16/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/array-float16/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/array-float16?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/array-float16.svg
[dependencies-url]: https://david-dm.org/stdlib-js/array-float16/main
...
[branches-url]: https://github.com/stdlib-js/array-float16/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/array-float16/main/LICENSE
