...
tape( 'attached to the prototype of the main export is a `findLastIndex` method', function test( t ) {
	t.strictEqual( hasOwnProp( Float16Array.prototype, 'findLastIndex' ), true, 'has property' );
	t.strictEqual( isFunction( Float16Array.prototype.findLastIndex ), true, 'has method' );
	t.end();
});
